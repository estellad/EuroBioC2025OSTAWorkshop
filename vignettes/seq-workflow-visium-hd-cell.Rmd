...
## Preparation
### Dataset
The relevant data by Oliveira et al. (2024) are stored on Open Science Framework, and can be downloaded as delayed format cached on your laptop through `r BiocStyle::Biocpkg("OSTA.data")`:
